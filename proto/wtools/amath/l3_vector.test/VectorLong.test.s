...
function mapDstIsNullSimpleVector( test )
{
  ...
  function testRun( makeLong )
  {
    ...
    var exp = _.avector.make( makeLong( [ 0 ] ) );
    test.identical( got, exp );
    test.true( got !== src );
  ...
  var dst = null;
  var src = _.avector.make( makeLong( [] ) );
  _.avector.map( dst, src, undefined );
...
function mapOnlyDstSimpleVector( test )
{
  ...
  function testRun( makeLong )
  {
    ...
    test.case = 'src - empty vector, onEach - undefined';
    var src = makeLong( [] );
    var got = _.avector.map( _.self, src, undefined );
    var exp = makeLong( [] );
    test.identical( got, exp );
    test.true( got === src );
    ...
    var got = _.avector.map( _.self, src, null );
    ...
    test.case = 'src - empty vector, onEach - undefined';
    var src = _.avector.make( makeLong( [] ) );
    test.shouldThrowErrorSync( () => _.avector.map( src, undefined ) );

    test.case = 'src - vector, onEach - null';
    var src = _.avector.make( makeLong( [ 1, 2, 3, 4, 5 ] ) );
    var got = _.avector.map( src, null );
    test.shouldThrowErrorSync( () => _.avector.map( src, null ) );
  }
}
...
function mapOnlyDstRoutineFromLong( test )
{
  ...
  function testRun( makeLong )
  {
    ...
    test.case = 'src - empty vector, onEach returns src.length';
    var src = _.vectorAdapter.fromLong( makeLong( [] ) );
    var got = _.avector.map( src, ( e, k, c, s ) => s.length );
    var exp = makeLong( [] );
    test.identical( got, exp );
    test.true( got !== src );
    ...
    test.case = 'src - empty vector, onEach returns dst.length';
    var src = _.vectorAdapter.fromLong( makeLong( [] ) );
    var got = _.avector.map( src, ( e, k, c, s, d ) => d.length );
    var exp = makeLong( [] );
    test.identical( got, exp );
    test.true( got !== src );
    ...
    test.case = 'src - empty vector, onEach returns undefined';
    var src = _.vectorAdapter.fromLong( makeLong( [] ) );
    var got = _.avector.map( src, ( e, k, c, s, d ) => undefined );
    var exp = makeLong( [] );
    test.identical( got, exp );
    test.true( got !== src );
...
function filterOnlyDstSimpleVector( test )
{
  ...
  function testRun( makeLong )
  {
    ...
    test.case = 'src - empty vector, onEach returns src.length';
    var src = _.avector.make( makeLong( [] ) );
    var got = _.avector.filter( src, ( e, k, c, s ) => s.length );
    var exp = _.avector.make( makeLong( [] ) );
    test.identical( got, exp );
    test.true( got === src );
    ...
    test.case = 'src - empty vector, onEach returns dst.length';
    var src = _.avector.make( makeLong( [] ) );
    var got = _.avector.filter( src, ( e, k, c, s, d ) => d.length );
    var exp = _.avector.make( makeLong( [] ) );
    test.identical( got, exp );
    test.true( got === src );
    ...
    test.case = 'src - empty vector, onEach returns undefined';
    var src = _.avector.make( makeLong( [] ) );
    var got = _.avector.filter( src, ( e, k, c, s, d ) => undefined );
    var exp = _.avector.make( makeLong( [] ) );
    test.identical( got, exp );
    test.true( got === src );
...
function filterDstIsVectorSimpleVector( test )
{
  ...
  function testRun( makeLong )
  {
    ...
    var dst = _.avector.make( makeLong( [ -1, -2 ] ) );
    var src = _.avector.make( makeLong( [ 1, 2, 3, 4, 5 ] ) );
    var got = _.avector.filter( dst, src, ( e ) => e );
...
function allSimpleVector( test )
{
  ...
  function testRun( makeLong )
  {
    ...
    test.case = 'src - empty vector, onEach - returns src.length';
    var src = makeLong( [] );
    var got = _.avector.all( src, ( e, k, c, s ) => s.length );
    test.identical( got, true );
...
function allRoutineFromNumberWithNumber( test )
{
  ...
  function testRun( makeLong )
  {
    ...
    test.case = 'src - empty vector, onEach - returns src.length';
    var src = _.vectorAdapter.fromNumber( 7, 0 );
    var got = _.vectorAdapter.all( src, ( e, k, c, s ) => s.length );
    test.identical( got, true );
