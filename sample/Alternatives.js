...
console.log( 'a1', a1 ); // log "a1 [ 2, 4, 8, 13 ]"
console.log( 'a2', a2 ); // log "a2 [ 1, 2, 3, 4 ]"
...
console.log( 'v1', v1.toStr() ); // log "v1 2.000 4.000 8.000 13.00"
console.log( 'v2', v2.toStr() ); // log "v2 1.000 2.000 3.000 4.000"
console.log( 'a', a ); // log "a [ 0, 2, 4, 8, 13, 0, 0, 1, 2, 3, 4, 0 ]"
