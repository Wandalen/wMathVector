...
Створюємо масиви `array1` та `array2`. Для них задаємо прості адаптери `vector1` та `vector2`. Додаємо вектори оперуючи адаптерами. Бачимо, що змінилося не лише значення `vector1`, а й значення `array1`.
...
- Реалізації інтерфейсу адаптера може мати довільну складність.
